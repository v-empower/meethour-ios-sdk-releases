/*
 * Copyright @ 2017-present Meet Hour, LLC
 *
...
#import <MeetHourSDK/MeetHourConferenceOptions.h>

@interface MeetHour : NSObject
 ...
 * with those passed to MeetHourView.join when joining a conference.
 */
@property (nonatomic, nullable) MeetHourConferenceOptions *defaultConferenceOptions;
...
- (MeetHourConferenceOptions *_Nonnull)getInitialConferenceOptions;
